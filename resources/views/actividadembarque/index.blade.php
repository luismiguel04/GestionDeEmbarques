                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Actividadembarque') }}
                            </span>

                             <div class="float-right">
                                <a href="{{ route('actividadembarques.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($actividadembarques as $actividadembarque)
                                        <tr>
											...
											<td>{{ $actividadembarque->Id_Embarque }}</td>
											<td>{{ $actividadembarque->Id_Actividad }}</td>
											<td>{{ $actividadembarque->Id_User }}</td>
